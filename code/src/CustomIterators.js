...
export const FormsCustomIterator = ({ record }) => {
  ...
  const onDragEnd = (result, provided) => {
    ...
    console.log(
      'Item at index ' + source.index + ' is now at index ' + destination.index,
    )
    ...
    const newArray = record.questions.filter(
...
export const PersonalCustomIterator = ({ record }) => {
  const notify = useNotify()
  const [mutate, { loading }] = useMutation(
    {},
    {
...
export const DocumentCustomIterator = ({ record }) => {
  const notify = useNotify()
  const [mutate, { loading }] = useMutation(
    {},
    {
...
export function EducationCustomIterator({ record }) {
  const notify = useNotify()
  const [mutate, { loading }] = useMutation(
    {},
    {
...
export const HobbiesCustomIterator = ({ record }) => {
  ...
  const onDragEnd = (result, provided) => {
    ...
    // Remove item from array
    const newArray = record.hobbies.filter(
      (el, index) => index !== source.index,
    )
...
export const EmploymentCustomIterator = ({ record }) => {
  const notify = useNotify()
  const [mutate, { loading }] = useMutation(
    {},
    {
...
export const JobCustomIterator = ({ record }) => {
  const notify = useNotify()
  const [mutate, { loading }] = useMutation(
    {},
    {
